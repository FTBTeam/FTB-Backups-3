...
/// [dev.ftb.mods.ftbbackups.api.event.RegisterArchivalPluginEvent#register(IArchivalPlugin)] to register new
...
public interface IArchivalPlugin {
    ...
    /// of the ID returned by [#getId()], and is appended (along with a ".") to the filename.
    ///
    ...
    /// Passed to [IArchivalPlugin#createArchive(ArchivalContext)]. This provides information about the backup
    ...
    /// Passed to [IArchivalPlugin#restoreArchive(RestorationContext)]. This provides information about the backup
